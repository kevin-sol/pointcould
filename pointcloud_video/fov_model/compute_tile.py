...
# 读取六个CSV文件
df1 = pd.read_csv(current_directory+'/prediction_x.csv')
df2 = pd.read_csv(current_directory+'/prediction_y.csv')
df3 = pd.read_csv(current_directory+'/prediction_z.csv')
df4 = pd.read_csv(current_directory+'/prediction_rx.csv')
df5 = pd.read_csv(current_directory+'/prediction_ry.csv')
df6 = pd.read_csv(current_directory+'/prediction_rz.csv')
...
result.to_csv(current_directory+'/prediction.csv', index=False)
